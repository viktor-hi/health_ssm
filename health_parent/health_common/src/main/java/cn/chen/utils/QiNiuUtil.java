...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "ObwzRzaYvji2jBtQ3hRUuBgjZGW0DRtuzCrFXbfY";
    private static final String SECRETKEY = "YThzBp75fIKwm8X_lVgfftpmsu7-y1Zt0zwEjvn6";
    private static final String BUCKET = "viktorhi";
    public static final String DOMAIN = "pyosgqxsa.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("/Users/haixin/Pictures/GoPro/2019-02-16/HERO7 BLACK 1/GOPR0006.JPG","GOPR0006.jpg");
